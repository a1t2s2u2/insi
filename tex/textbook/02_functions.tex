...
\begin{remark}{区間の選び方}{tb-inverse-trig-branch}
...
\begin{remark}{グラフは直線 $y=x$ に関する折り返し}{tb-inverse-trig-graph}
...
\begin{remark}{直角三角形から導く}{tb-inverse-trig-triangle}
公式は覚えなくても、その場で作れる。
...
\]
実際 $\theta=\arcsin x$ とすると $\cos(\pi/2-\theta)=\sin\theta=x$ であり、
