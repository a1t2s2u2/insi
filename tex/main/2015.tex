...
\[
\varphi'(t)=x\frac{\partial f}{\partial x}(tx,ty)+y\frac{\partial f}{\partial y}(tx,ty)
\]
...
&=x\int_0^1\frac{\partial f}{\partial x}(tx,ty)\,\d t
 +y\int_0^1\frac{\partial f}{\partial y}(tx,ty)\,\d t.
\end{align*}
従って
\[
g(x,y)=\int_0^1\frac{\partial f}{\partial x}(tx,ty)\,\d t,
\qquad
h(x,y)=\int_0^1\frac{\partial f}{\partial y}(tx,ty)\,\d t
\]
とおけば $f=xg+yh$ となる。$\partial f/\partial x$, $\partial f/\partial y$ は滑らかであり、コンパクト区間 $0\le t\le1$ 上の
...
&=x\int_0^1\frac{\partial f}{\partial x}(sx,y)\,\d s.
\end{align*}
...
&=y\int_0^1\frac{\partial f}{\partial y}(0,ty)\,\d t.
\end{align*}
そこで
\[
G(x,y)=\int_0^1\frac{\partial f}{\partial x}(sx,y)\,\d s,
\qquad
H(y)=\int_0^1\frac{\partial f}{\partial y}(0,ty)\,\d t
\]
とおけば、$G,H$ は滑らかであり
\[
f(x,y)=xG(x,y)+yH(y)
